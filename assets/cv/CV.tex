...
\begin{document}
    ...
    \item{Data-centric Natural Language Processing, Aligning LLMs/VLMs to build trustworthy AI,\\ RAG \& domain adaptation of LLMs for domain-specific question answering}
    \end{enumerate}
